    ...
    <div class="col-md-7">
        <div class="widget-box widget-color-blue2">
            ...
            <div class="widget-body">
                ...
                echo form_open('biayapembangunan/add');
                
                ?>

<div class="form-group">
    <label>Jenis Pembangunan</label>
    <input name="jenis" type="text" class="form-control" placeholder="Jenis Pembangunan" required>
</div>

<div class="form-group">
    <label>Volume (Unit)</label>
    <input name="volume" type="text" class="form-control" placeholder="Volume (Unit)" required>
</div>

<div class="form-group">
    <label>Satuan</label>
    <input name="satuan" type="text" class="form-control" placeholder="Satuan" required>
</div>

<div class="form-group">
    <label>Harga Satuan (Rp)</label>
    <input name="harga_satuan" type="text" class="form-control" placeholder="Harga Satuan (Rp)" required>
</div>

<div class="form-group">
    <label>Jumlah Harga (Rp)</label>
    <input name="jumlah_harga" type="text" class="form-control" placeholder="Jumlah Harga (Rp)" required>
</div>
