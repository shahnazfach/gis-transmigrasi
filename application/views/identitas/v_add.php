	...
	<div class="col-md-7">
		<div class="widget-box widget-color-blue2">
			...
			<div class="widget-body">
				...
				echo form_open('identitas/add');
				
				?>

<div class="form-group">
	<label>Alamat Website</label>
	<input name="judul_website" type="text" class="form-control" placeholder="Alamat Website" required>
</div>

<div class="form-group">
	<label>Alamat Kantor</label>
	<input name="alamat" type="text" class="form-control" placeholder="Alamat Kantor" required>
</div>
